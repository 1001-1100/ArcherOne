...
class Friends extends React.Component{
    ...
    getInfo(){
        this.refreshFriends();
        axios.get('https://animosched-backend-backup/api/friendrequestlist/'+localStorage.getItem('user_id')+'/')
        .then(res => {
    ...
    refreshFriends(){
        ...
        axios.get('https://animosched-backend-backup/api/sentrequestlist/'+localStorage.getItem('user_id')+'/')
        .then(res => {
            const sentRequests = [];
            res.data.map(sent => {
                sentRequests.push(sent.to_user)
            })
            axios.get('https://animosched-backend-backup/api/nonfriendlist/'+localStorage.getItem('user_id')+'/')
            .then(res => {
                const database = [];
    ...
    handleFriendsClick = (e, action) => {
        ...
        this.state.requests.map(request => {
            axios.patch('https://animosched-backend-backup/api/friendrequests/'+request.id+'/',{
                seen: true
            })
    ...
    handleAcceptClick = (e, index, id, from_user) => {
        ...
        .then(res => {
            ...
            axios.patch('https://animosched-backend-backup/api/friendrequests/'+id+'/',{
                seen: true,
                accepted: true
            })
            // axios.post('https://animosched-backend-backup/api/notifications/',{
    ...
    handleDeleteClick = (e, index, id) => {
        this.setState({polling: false})
        axios.delete('https://animosched-backend-backup/api/friendrequests/'+id+'/')
        const requests = [];
    ...
    handleSendClick = (e, index, id) => {
        this.setState({polling: false})
        axios.post('https://animosched-backend-backup/api/friendrequests/',{
