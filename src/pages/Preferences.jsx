...
class Preferences extends Component {
    ...
    componentDidMount(){
        ...
        axios.get('https://api.animosched.live/api/faculty/')
        .then(res => {
        ...
        // axios.get('https://api.animosched.live/api/sections/')
        // .then(res => {
        ...
        //     })
        // });
            axios.get('https://api.animosched.live/api/preferencelist/'+id+'/')
            .then(res => {
    ...
    handleSave = () => {
        ...
        const id = localStorage.getItem('user_id');
        axios.delete('https://api.animosched.live/api/preferencelist/'+id+'/')
        .then(res => {
            console.log(this.state.daysList)
            this.state.daysList.map(day =>{
                if(day.checked){
                    axios.post('https://api.animosched.live/api/preferences/', {preferred_days: day.id, user: id},
                    {
                        headers: {
            ...
            this.state.buildingList.map(bldg =>{
                if(bldg.checked){
                    axios.post('https://api.animosched.live/api/preferences/', {preferred_buildings: bldg.id, user: id},
                    {
                        headers: {
                            'Content-Type': 'application/json'
                        }
            ...
            this.state.selectedProfs.map(prof =>{
                console.log(prof)
                axios.post('https://api.animosched.live/api/preferences/', {preferred_faculty: prof.id, user: id},
                {
                    headers: {
                        'Content-Type': 'application/json'
                    }
            ...
            this.state.selectedSections.map(section =>{
                console.log(section)
                axios.post('https://api.animosched.live/api/preferences/', {preferred_sections: section.section_code, user: id},
                {
                    headers: {
                        'Content-Type': 'application/json'
                    }
            ...
            axios.post('https://api.animosched.live/api/preferences/', data,
            {
                headers: {
                    'Content-Type': 'application/json'
                }
